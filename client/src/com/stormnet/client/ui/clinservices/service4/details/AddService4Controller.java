...
public class AddService4Controller {
    ...
    public void addService(ActionEvent actionEvent) throws IOException {
        ...
        jsonWriter.key("firstName").value("МОЙКА ОКОН И ВИТРИН");
        ...
        if (responseCode == 200) {
            ...
            factory.hideWindow("addService4Window");
    ...
    public void cancelBtnPressed(ActionEvent actionEvent) {
        ...
        windowsFactory.hideWindow("addService4Window");
