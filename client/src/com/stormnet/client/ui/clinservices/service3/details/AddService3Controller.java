...
public class AddService3Controller {
    ...
    public void addService(ActionEvent actionEvent) throws IOException {
        ...
        jsonWriter.key("firstName").value("УБОРКА ОФИСОВ И ПРОИЗВОДСТВЕННЫХ ПОМЕЩЕНИЙ");
        ...
        if (responseCode == 200) {
            ...
            factory.hideWindow("addService3Window");
    ...
    public void cancelBtnPressed(ActionEvent actionEvent) {
        ...
        windowsFactory.hideWindow("addService3Window");
