...
public class AddService5Controller {
    ...
    public void addService(ActionEvent actionEvent) throws IOException {
        ...
        jsonWriter.key("firstName").value("ХИМЧИСТКА МЕБЕЛИ И ПОКРЫТИЙ");
        ...
        if (responseCode == 200) {
            ...
            factory.hideWindow("addService5Window");
    ...
    public void cancelBtnPressed(ActionEvent actionEvent) {
        ...
        windowsFactory.hideWindow("addService5Window");
